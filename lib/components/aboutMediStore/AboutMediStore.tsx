    ...
    return (
        <div className='p-4 flex flex-col gap-4 text-md md:text-xl text-gray-600 mb-6'>
            ...
            <div>
                ...
                <ul>
                    <li>Provide safe and authentic medicines.</li>
                    <li>Make healthcare accessible to everyone.</li>
                    <li>Deliver a seamless and secure online shopping experience.</li>
                    <li>Promote better health and well-being in our community.</li>
                </ul>
            </div>
            <div>
                <strong>What We Offer</strong>
                <ul>
                    <li>Prescription and non-prescription medicines</li>
                    <li>Healthcare and wellness products</li>
                    <li>Fast and reliable delivery services</li>
                    <li>Secure online ordering and payment options</li>
            ...
            <div>
                ...
                ✅ Secure transactions and data protection<br />
                ✅ Fast delivery and order tracking<br />
